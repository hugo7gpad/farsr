---
title: "Introduction_to_farsr"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction_to_farsr}
...
The goal of farsr is to offer tools to report and analyse accidents reports data over years.The farsr package provides functions to read, summarize and visualize data on accidents recorded by time, date, geographical information such as: city, state, longitude, latitude… and more.
...
included to illustrate how to use these functions:
